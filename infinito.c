...
int main()
{
    ...
    default:
                ...
                case 0:
                    ...
                    case 0:
                        ...
                        while (1)
                        {
                            ...
                            if (kill(pidh4, SIGUSR1) == -1)
                            {
                                perror("Error en kill USR1 a H4");
                                exit(-1);
                            }
        ...
        if (kill(pidh3, SIGUSR1) == -1)
        {
            perror("Error en kill USR1 h3");
            exit(-1);
        }
        while (1)
        {
